...
export default function Settings() {
  ...
  const [emailBody, setEmailBody] = useState('Hello! This is a test email from System A.')
  ...
  const handleEmailTest = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.PROD ? '/api' : 'http://localhost:3001/api'}/email/test`, {
        method: 'POST',
    ...
    <div className="dashboard">
      ...
      <main className="dashboard-main" style={{maxWidth: 520, margin: '0 auto'}}>
        ...
        <form onSubmit={handleEmailTest} className="auth-card" style={{backdropFilter:'none'}}>
          ...
          <p style={{color:'#888',fontSize:'0.85rem',marginBottom:8}}>用 Resend API 發送測試電郵</p>
